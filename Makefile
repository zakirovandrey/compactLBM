...
UPDATE_CONEFOLD_FILE = updateConeFold.cu
STEP_FILE = steps.cu
STEP_CONEFOLD_FILE = stepsConeFold.cu
DROP_FILE = drop.cu
INIT_FILE = init.cu
...
common.o: ker-run.o data.o update.o updateConeFold.o steps.o stepsConeFold.o drop.o init.o draw_im3D.o
	ar rvs $@ $+
...
#lbm: ker_fastlab.o fill_init.o update.o step.o moments.o drop.o mesh_reform.o draw_im3D.o ../core/core_fastlab.o
